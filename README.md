...
### To Do
- [x] Practicing unit testing via the Test Driven Development (TDD) methodology
- [x] Using the Mocha BDD test framework
- [x] Using the Chai assertion library
- [x] Creating and consuming modules using Node's default CommonJS syntax (module.exports and require)
